...
public class MouvementStock {
    ...
    private String motif; // "achat", "perte", "inventaire", etc.

    // Enum pour les types de mouvement (optionnel mais recommandé)
    public static final String TYPE_ENTREE = "ENTRÉE";
    public static final String TYPE_SORTIE = "SORTIE";

    // Constructeurs
    public MouvementStock() {
        this.dateMouvement = new Date(); // Date actuelle par défaut
    }
    ...
    public String toString() {
        return type + " de " + quantite + " " + produit.getNom() + " - " + motif + " (" + dateMouvement + ")";
    }
}
